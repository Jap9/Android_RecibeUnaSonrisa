...
public class Fragment2_registrat_editar_perfil extends Fragment {
    private Button a;
    ...
    public Fragment2_registrat_editar_perfil() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        getActivity().getActionBar().setTitle("Editar perfil");
        View view = inflater.inflate(R.layout.fragment2_registrat_editar_perfil,
                container, false);
        ...
        titol.setText("Editar perfil");

        EditText vision = (EditText) view.findViewById(R.id.descripcion);
        EditText correo = (EditText) view.findViewById(R.id.usuarios);

        correo.getBackground().setColorFilter(getResources().getColor(R.color.white),
                PorterDuff.Mode.SRC_ATOP);

        vision.getBackground().setColorFilter(getResources().getColor(R.color.med),
                PorterDuff.Mode.SRC_ATOP);
...
// ...Irrelevant code for customizing the buttons and title
        ...
        Button buttons = (Button) view.findViewById(R.id.guardar);
