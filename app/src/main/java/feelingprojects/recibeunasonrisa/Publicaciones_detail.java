...
public class Publicaciones_detail extends BaseAdapter {
    Context context;
    ...
    public Publicaciones_detail(Context context,ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View itemview = inflater.inflate(R.layout.adapter_pedir, parent, false);
