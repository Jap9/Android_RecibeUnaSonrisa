...
public class Publicaciones_detail_administrar_donaciones extends BaseAdapter {
    Context context;
    ...
    public Publicaciones_detail_administrar_donaciones(Context context,ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View itemview = inflater.inflate(R.layout.adapter_administrar_donaciones, parent, false);
