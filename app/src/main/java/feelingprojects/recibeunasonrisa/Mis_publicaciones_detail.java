...
public class Mis_publicaciones_detail extends BaseAdapter {
    Context context;
    ...
    public Mis_publicaciones_detail(Context context,ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View itemview = inflater.inflate(R.layout.adapter_mis_publicaciones, parent, false);
